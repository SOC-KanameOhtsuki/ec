...
class AdminControllerProvider implements ControllerProviderInterface
{
    public function connect(Application $app)
    {
        ...
        $c->match('/form_printing/membership_payment_status_list_download', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::membershipPaymentStatusListExport')->bind('admin_form_printing_membership_payment_status_list_export');
