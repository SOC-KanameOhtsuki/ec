...
class AdminControllerProvider implements ControllerProviderInterface
{
    public function connect(Application $app)
    {
        ...
        $c->match('/form_printing/payment/download/all/pdf', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::paymentAllExport')->bind('admin_payment_all_export');
        $c->match('/form_printing/payment/download/select/pdf', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::paymentSelectExport')->bind('admin_payment_select_export');
        $c->match('/form_printing/payment/download/all/csv', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::paymentAllCsvExport')->bind('admin_all_csv_export');
        $c->match('/form_printing/payment/download/select/csv', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::paymentSelectCsvExport')->bind('admin_select_csv_export');
        ...
        $c->match('/form_printing/invoice/download/all', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::invoiceAllExport')->bind('admin_invoice_all_export');
        $c->match('/form_printing/invoice/download/select', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::invoiceSelectExport')->bind('admin_invoice_select_export');
        ...
        $c->match('/form_printing/delivery/download/all', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::deliveryAllExport')->bind('admin_delivery_all_export');
        $c->match('/form_printing/delivery/download/select', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::deliverySelectExport')->bind('admin_delivery_select_export');
        ...
        $c->match('/form_printing/business_card/download/all', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::businessCardAllExport')->bind('admin_business_card_list_all_export');
        $c->match('/form_printing/business_card/download/select', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::businessCardSelectExport')->bind('admin_business_card_list_select_export');
        ...
        $c->match('/form_printing/certification/download/all', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::certificationAllExport')->bind('admin_certification_all_export');
        $c->match('/form_printing/certification/download/select', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::certificationSelectExport')->bind('admin_certification_select_export');
        ...
        $c->match('/form_printing/mail_label/download/all', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::mailLabelAllExport')->bind('admin_form_printing_mail_label_all_export');
        $c->match('/form_printing/mail_label/download/select', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::mailLabelSelectExport')->bind('admin_form_printing_mail_label_select_export');
        ...
        $c->match('/form_printing/membership_payment_status_list/download', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::membershipPaymentStatusListExport')->bind('admin_form_printing_membership_payment_status_list_export');
        ...
        $c->match('/form_printing/donation_list/download/donation_list_csv', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::donationListCsvExport')->bind('admin_form_printing_donation_list_csv_export');
        $c->match('/form_printing/donation_list/download/donation_list_pdf', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::donationListExport')->bind('admin_form_printing_donation_list_pdf_export');
        $c->match('/form_printing/donation_list/download/donation_certificate_pdf', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::donationCertificateExport')->bind('admin_form_printing_donation_certificate_export');
        ...
        $c->match('/form_printing/regular_member_list/download/all_without_anonymous', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::regularMemberListAllExportWithoutAnonymous')->bind('admin_regular_member_all_export_without_anonymous');
        $c->match('/form_printing/regular_member_list/download/select_without_anonymous', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::regularMemberListSelectExportWithoutAnonymous')->bind('admin_regular_member_select_export_without_anonymous');
        $c->match('/form_printing/regular_member_list/download/all', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::regularMemberListAllExport')->bind('admin_regular_member_all_export');
        $c->match('/form_printing/regular_member_list/download/select', '\Eccube\Controller\Admin\FormPrinting\FormPrintingController::regularMemberListSelectExport')->bind('admin_regular_member_select_export');
