...
/**
 * Class MailAcceptFormPdfService.
 * Do export pdf function.
 */
class MailAcceptFormPdfService extends AbstractFPDIService
{
    // ====================================
    // 定数宣言
    // ====================================
    ...
    public function makePdf(array $orders)
    {
        ...
        foreach ($orders as $order) {
            // PDFにページを追加する
            $templateFilePath = __DIR__.'/../Resource/pdf/acceptance_form_mail1.pdf';
            ...
            // PDFにページを追加する
            $templateFilePath = __DIR__.'/../Resource/pdf/acceptance_form_mail2.pdf';
            $this->setSourceFile($templateFilePath);
            $this->addPdfPage();
        }
